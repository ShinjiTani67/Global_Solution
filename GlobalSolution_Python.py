...
def cadastro():
        print("nome = fernando")
        print("sobrenome = shinji")
        print("nome de usuario = nando")
        print("email = global_solution@mail.com")
        print("senha = 123")
        nome = input("Digite o seu nome: ")
        sobrenome = input("Digite o seu sobrenome: ")
        nome_usuraio_cadastro = input("Crie um nome de usuario: ")
        email = input("Digite o seu email: ")
        senha = input("Crie uma senha: ")
        senha_confirmacao = input("Confirme a senha: ")
        if senha != senha_confirmacao:
            print("senhas não são diferentes")
        lista_cadastro = [nome, sobrenome, nome_usuraio_cadastro, email, senha]
